...
#[allow(dead_code)]
pub static TARGET: &str = "armv7-unknown-linux-musleabihf";
...
#[allow(dead_code)]
pub static RUSTC: &str = "/usr/local/rustup/toolchains/1.86.0-x86_64-unknown-linux-gnu/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/usr/local/rustup/toolchains/1.86.0-x86_64-unknown-linux-gnu/bin/rustdoc";
...
#[doc=r#"The output of `/usr/local/rustup/toolchains/1.86.0-x86_64-unknown-linux-gnu/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.86.0 (05f9846f8 2025-03-31)";
#[doc=r#"The output of `/usr/local/rustup/toolchains/1.86.0-x86_64-unknown-linux-gnu/bin/rustdoc -V`; empty string if `/usr/local/rustup/toolchains/1.86.0-x86_64-unknown-linux-gnu/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.86.0 (05f9846f8 2025-03-31)";
#[doc=r#"The target architecture, given by `CARGO_CFG_TARGET_ARCH`."#]
#[allow(dead_code)]
pub static CFG_TARGET_ARCH: &str = "arm";
